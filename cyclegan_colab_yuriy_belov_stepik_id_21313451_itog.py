# -*- coding: utf-8 -*-
"""CycleGAN_Colab_Yuriy_Belov_stepik_ID_21313451_itog.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BDAWqVgtG1GcLfr8oZfZcnjVcaQ1YKKK
...
"""#### Все закомментированные ниже функции, процедуры и переменные заданы в самом низу, в цикле выбора нужного нам этапа: обучения, валидации или трейна."""
...
"""#### Цикл выбора нужного нам этапа: обучения, валидации или трейна"""
